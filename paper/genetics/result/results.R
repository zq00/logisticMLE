...
beta_est <- read.table('beta_est.txt', header=FALSE)
cov_est <- read.table('cov_est.txt', header=FALSE)
dev <- scan('dev.txt')
gamma_hat <- scan('gamma_hat.txt')
param <- read.table('param.txt', header=FALSE)
pc <- read.table('pc.txt', header=FALSE)
std_est <- read.table('std_est.txt', header=FALSE)
